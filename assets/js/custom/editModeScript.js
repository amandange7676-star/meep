$(document).ready(function () {
    ...
    function toggleEditableClasses(enable) {
        ...
        //    $('#wrapper.editableSection .header-39-top-bar').removeClass('editMode-addedMargin');
    ...
    const modalHtml = `
        <div class="modal fade" id="dynamicModal" tabindex="-1" aria-labelledby="dynamicModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
				...
				<div id="default-middle_section" class="component"></div>
				<!-- <div id="home-1" name="Section-1 for Home Page" class="component"></div> -->
				<!-- <div id="ourteam-1" class="component" category="Doctors"></div> -->
				<div id="home-1" class="component" category="Auto Repair Shops"></div>
				<div id="home-2" class="component" category="Auto Repair Shops"></div>
				<div id="home-3" class="component" category="Tutor"></div>
				<div id="home-4" class="component" category="Coaching center"></div>
				<div id="home-5" class="component" category="Coaching center"></div>
				<div id="home-6" class="component" category="Coaching center"></div>
				<div id="home-7" class="component" category="School"></div>
				<!-- <div id="home-8" class="component" category="Hotel"></div> -->
				<div id="home-9" class="component" category="Hotel/Lounges"></div>
				<div id="home-10" class="component" category="Hotel/Lounges"></div>
				<div id="home-11" class="component" category="Hotel/Lounges"></div>
				<!-- <div id="home-12" class="component" category="Corporate/Company Site"></div> -->
				<div id="home-13" class="component" category="Coaching center"></div>
				<div id="home-14" class="component" category="Portfolio"></div>
				<div id="home-15" class="component" category="Small Business"></div>
				<div id="home-16" class="component" category="Portfolio"></div>
				<div id="home-17" class="component" category="Portfolio"></div>
				<div id="home-18" class="component" category="Portfolio"></div>
				...
				<div id="home-29" class="component" category="Influencer"></div>
				<div id="home-30" class="component" category="Influencer"></div>
				<div id="home-31" class="component" category="Influencer"></div>
				<!-- <div id="home-32" class="component" category="Small Business"></div> -->
				<div id="home-33" class="component" category="Small Business"></div>
				<div id="home-34" class="component" category="Real Estate Agencies"></div>
				<div id="home-35" class="component" category="Real Estate Agencies"></div>
				<div id="home-36" class="component" category="Yoga & Meditation"></div>
				<div id="home-37" class="component" category="Nutritionist"></div>
				<div id="home-38" class="component" category="Yoga & Meditation"></div>
				...
				<div id="home-42" class="component" category="Real Estate Agencies"></div>
				<div id="home-43" class="component" category="Fitness & Gym"></div>
				<div id="home-44" class="component" category="Clinic"></div>
				<div id="home-45" class="component" category="Photography"></div>
				<div id="home-46" class="component" category="Photography"></div>
				<div id="home-47" class="component" category="Nutritionist"></div>
				<div id="home-48" class="component" category="Chartered Accountant"></div>
				<div id="home-49" class="component" category="Advocate "></div>
				<div id="home-50" class="component" category="Advocate "></div>
				<div id="home-51" class="component" category="Clinic"></div>
				<div id="home-52" class="component" category="Clinic"></div>
				<!-- <div id="home-53" class="component" category="Photography"></div> -->
				<div id="home-54" class="component" category="Travel Blogs"></div>
				<!-- <div id="home-55" class="component" category="Travel Blogs"></div> -->
				<div id="home-56" class="component" category="Photography"></div>
				<div id="home-57" class="component" category="Photography"></div>
				<!-- <div id="home-58" class="component" category="Photography"></div> -->
				<div id="home-59" class="component" category="Yoga & Meditation"></div>
				<div id="home-60" class="component" category="Yoga & Meditation"></div>
				<div id="home-61" class="component" category="Influencer"></div>
				<div id="home-62" class="component" category="Influencer"></div>
				<div id="home-63" class="component" category="Influencer"></div>
				<div id="home-64" class="component" category="Portfolio"></div>
				<div id="home-65" class="component" category="Portfolio"></div>
				<div id="home-66" class="component" category="Portfolio"></div>
				<div id="home-67" class="component" category="Portfolio"></div>
				<div id="home-68" class="component" category="Portfolio"></div>
				<!-- <div id="home-69" class="component" category="Software Companies"></div> -->
				<!-- <div id="home-70" class="component" category="Tech Startups"></div> -->

				<div id="about-1" class="component" category="Collage"></div>
				<!-- <div id="about-2" class="component" category="Corporate/Company Site"></div> -->
				<div id="about-3" class="component" category="Coaching center"></div>
				<div id="about-4" class="component" category="Collage"></div>
				<div id="about-5" class="component" category="Coaching center"></div>
				<div id="about-6" class="component" category="Tutor"></div>
				<div id="about-7" class="component" category="Clinic"></div>
				<div id="about-8" class="component" category="Clinic"></div>
				<div id="about-9" class="component" category="Hotel/Lounges"></div>
				...
				<div id="about-17" class="component" category="Real Estate Agencies"></div>
				<div id="about-18" class="component" category="Music & Performing Arts"></div>
				<div id="about-19" class="component" category="Clinic"></div>
				<div id="about-20" class="component" category="Event Planner"></div>
				<!-- <div id="about-21" class="component" category="Vacation Rentals"></div> -->
				<div id="about-22" class="component" category="Restaurants"></div>
				<div id="about-23" class="component" category="Fitness & Gym"></div>
				<div id="about-24" class="component" category="Clinic"></div>
				<div id="about-25" class="component" category="Photography"></div>
				<div id="about-26" class="component" category="Nutritionist"></div>
				<div id="about-27" class="component" category="Nutritionist"></div>
				<div id="about-28" class="component" category="Coaching center"></div>
				<div id="about-29" class="component" category="Coaching center"></div>
				<div id="about-30" class="component" category="Chartered Accountant"></div>
				<div id="about-31" class="component" category="Advocate"></div>
				<div id="about-32" class="component" category="Clinic"></div>

				<div id="about-33" class="component" category="Clinic"></div>
				<div id="about-34" class="component" category="Yoga & Meditation"></div>

				<div id="about-35" class="component" category="Yoga & Meditation"></div>
				<div id="about-36" class="component" category="Portfolio"></div>
				<div id="about-37" class="component" category="Portfolio"></div>
				<div id="about-38" class="component" category="Portfolio"></div>
				<div id="about-39" class="component" category="Portfolio"></div>
				<div id="about-40" class="component" category="Portfolio"></div>
				<!-- <div id="about-41" class="component" category="Software Companies"></div> -->
				<!-- <div id="about-42" class="component" category="Tech Startups"></div> -->


				<!-- <div id="courses-1" class="component" category="Corporate/Company Site"></div> -->
				<div id="courses-2" class="component" category="Tutor"></div>
				<div id="courses-3" class="component" category="Tutor"></div>
				<div id="courses-4" class="component" category="Pre-school & Daycare"></div>
				<div id="courses-5" class="component" category="Fitness & Gym"></div>
				<div id="courses-6" class="component" category="Coaching center"></div>
				<!-- <div id="courses-7" class="component" category="Software Companies"></div> -->

				<div id="events-1" class="component" category="Tutor"></div>
				<!-- <div id="events-2" class="component" category="Corporate/Company Site"></div> -->
				<div id="events-3" class="component" category="Event Planner "></div>
				<div id="events-4" class="component" category="Chartered Accountant"></div>
				<div id="events-5" class="component" category="Chartered Accountant"></div>


				<div id="news-1" class="component" category="Financial Advisors"></div>
				<div id="news-2" class="component" category="Coaching center"></div>
				<div id="news-3" class="component" category="Auto Repair Shops"></div>
				<!-- <div id="news-4" class="component" category="Artist/Illustrator"></div> -->
				<div id="news-5" class="component" category="Event Planner"></div>
				<div id="news-6" class="component" category="Clinic"></div>
				...
				<div id="testimonial-4" class="component" category="Clinic"></div>
				...
				<div id="testimonial-12" class="component" category="Restaurants"></div>
				<div id="testimonial-13" class="component" category="Nutritionist"></div>


				<div id="slider-1" class="component" category="School"></div>
				<div id="slider-2" class="component" category="Electronic Item Services"></div>
				<div id="slider-4" class="component" category="Restaurants"></div>
				...
				<div id="pricing-4" class="component" category="Tutor"></div>
				<div id="pricing-5" class="component" category="Coaching center"></div>
				<div id="pricing-6" class="component" category="Coaching center"></div>
				<div id="pricing-7" class="component" category="Photography"></div>
				<div id="pricing-8" class="component" category="Chartered Accountant"></div>
				<div id="pricing-9" class="component" category="Chartered Accountant"></div>
				...
				<div id="contact-9" class="component" category="Real Estate Agencies"></div>
				<div id="contact-10" class="component" category="Restaurants"></div>
				<div id="contact-11" class="component" category="Fitness & Gym"></div>
				<div id="contact-12" class="component" category="Coaching center"></div>
				<div id="contact-13" class="component" category="Chartered Accountant"></div>
				<div id="contact-14" class="component" category="Advocate "></div>
				<div id="contact-15" class="component" category="Portfolio"></div>
				<!-- <div id="contact-16" class="component" category="Tech Startups"></div> -->

				<div id="services-1" class="component" category="Clinic"></div>
				<div id="services-2" class="component" category="Clinic"></div>
				<div id="services-3" class="component" category="Clinic"></div>
				<div id="services-4" class="component" category="Hotel/Lounges"></div>
				<div id="services-5" class="component" category="Chartered Accountant"></div>
				<div id="services-6" class="component" category="Chartered Accountant"></div>
				<div id="services-7" class="component" category="Financial Advisors"></div>
				<div id="services-8" class="component" category="Music & Performing Arts"></div>
				...
				<div id="services-13" class="component" category="Nutritionist"></div>
				...
				<div id="services-16" class="component" category="Restaurants"></div>
				<div id="services-17" class="component" category="Clinic"></div>
				<div id="services-18" class="component" category="Coaching center"></div>
				<div id="services-19" class="component" category="Advocate "></div>
				<div id="services-20" class="component" category="Clinic"></div>
				<div id="services-21" class="component" category="Portfolio"></div>
				<!-- <div id="services-22" class="component" category="Tech Startups"></div> -->

				<div id="blog-2" class="component"></div>
				<div id="blog-6" class="component" category="Clinic"></div>
				...
				<div id="blog-12" class="component" category="Fitness & Gym"></div>
				<div id="blog-13" class="component" category="Nutritionist"></div>
				<div id="blog-14" class="component" category="Coaching center"></div>

				<div id="faq-1" class="component"></div>
				<div id="faq-2" class="component"></div>
				<div id="faq-3" class="component" category="Influencer"></div>
				<div id="faq-4" class="component" category="Home Staging"></div>
				<div id="faq-5" class="component" category="Chartered Accountant"></div>
				...
				<div id="newsletter-5" class="component" category="Coaching center"></div>

				<div id="ourteam-1" class="component" category="Clinic"></div>
				...
				<div id="ourteam-4" class="component" category="Chartered Accountant"></div>

				<div id="help-1" class="component" category="School"></div>
				<div id="help-2" class="component" category="Coaching center"></div>
...
function handleSaveSection() {
    ...
    for (let section in selectedIds) {
        selectedIds[section].forEach(function(id) {
            ...
            // Remove old radio-holder if exists
            sectionToClone.find('.radio-holder').remove();

            // Find the target wrapper
            let targetWrapper = targetId ? $('#' + targetId).closest('.section-wrapper') : null;

            // If middle_section_default exists, replace it with the cloned section
            if ($('#middle_section_default').length > 0) {
                $('#middle_section_default').replaceWith(sectionToClone);
                inserted = true;
                ...
                $('#middle_section_container').prepend(sectionToClone);
                inserted = true;
            }
    ...
    // If sections were inserted, reset the selected sections and close the modal
    if (inserted) {
...
function addActionButtons(sectionWrapper) {
    ...
    const addAboveButtonHtml = `
        <button class="add-section-above" style="position: absolute; left: 47%; top: 25px; z-index:999;" data-target-id="${sectionId}" data-action="above">
            Add Section Above
            <span><img src="assets/images/arrow_up.png" style="width: 20px; height: 20px;"/></span>
        </button>
    `;
    const addBelowButtonHtml = `
        <button class="add-section-below" style="position: absolute; left: 47%; bottom: 22px; z-index:999;" data-target-id="${sectionId}" data-action="below">
            Add Section Below
            <span><img src="assets/images/arrow_down.png" style="width: 20px; height: 20px;"/></span>
        </button>
    `;
const removeButtonHtml = `
    <div class="remove-section-btn-wrapper">
        <button class="remove-section-btn" data-target-id="${sectionId}">&times;</button>
    </div>
`;
    ...
    // Bind event handlers
    sectionWrapper.find('.add-section-above, .add-section-below').on('click', handleAddSectionButton);
    sectionWrapper.find('.remove-section-btn').on('click', handleRemoveSection);
